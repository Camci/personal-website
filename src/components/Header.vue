  ...
  <header class="bg-transparent backdrop-blur-sm shadow-sm sticky top-0 z-50 transition-all duration-300">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex justify-between h-16">
        ...
        <nav class="hidden md:flex space-x-8 items-center">
          ...
          <a href="#contact" class="btn btn-primary text-sm hover:shadow-lg transition-all">Contact Me</a>
        </nav>
    ...
    <div v-if="mobileMenuOpen" class="md:hidden bg-transparent backdrop-blur-md shadow-lg">
      <div class="pt-2 pb-3 space-y-1">
        ...
        <a href="#contact" 
          class="block px-3 py-2 text-base font-medium text-primary hover:bg-gray-50/50 transition-colors"
          @click="mobileMenuOpen = false">
          Contact Me
        </a>
      </div>
